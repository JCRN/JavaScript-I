...
// challenge 1 alts:
let index = inventory.findIndex(x => x.id === 33);
...
console.log('Car models sorted alphabetically in ascending order:', carModels.sort());
...
console.log('Years from every car on the lot:', carYears);
